...
export default function Footer() {
  ...
  return (
    <footer className={`flex flex-col bg-white w-full`}>
      <div className={`bg-black px-8 py-5 flex flex-col sm:flex-row items-center justify-between rounded-lg space-y-4 sm:space-y-0 z-10 ${styles.marginX}`}>
        <div className='w-full sm:w-1/2'>
          <p className='uppercase sm:max-w-sm text-white text-lg sm:text-2xl font-bold'>stay upto date about our latest offers</p>
        </div>
        <form onSubmit={handleSubmit} className='w-full ss:w-2/5 md:w-1/3 flex flex-col justify-center items-center space-y-4'>
      ...
      <div className={`bg-[rgb(240,240,240)] -mt-[100px] sm:-mt-[70px] pt-[120px] sm:pt-24 z-0 ${styles.paddingX}`}>
