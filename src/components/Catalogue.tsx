    ...
    return (
        <div className={`w-full bg-white py-12 z-0 ${styles.paddingX}`}>
            <div className='flex flex-col space-y-12'>
                ...
                <div className="flex flex-col space-y-6">
                    <h1 className='text-lg sm:text-2xl font-bold uppercase text-center'>top sellings</h1>
                    <Slider items={products.slice(6)} />
                </div>
                <div className="flex flex-col space-y-8 bg-[#F0F0F0] rounded-lg px-5 md:px-8 pb-12 pt-10">
                    <h1 className='text-lg sm:text-2xl font-bold uppercase text-center'>browse by dress style</h1>
                    <ItemGallery />
                </div>
            </div>
        </div>
