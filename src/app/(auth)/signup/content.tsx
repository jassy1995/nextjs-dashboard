    ...
    return (
        <form className='bg-white rounded-lg p-8 sm:p-12 shadow-md w-full max-w-sm'>
            ...
            <div className="mb-4">
                ...
                <input type="text" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="fullname" placeholder="fullname" />
            </div>
            <div className="mb-4">
